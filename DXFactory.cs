...
{
    public class DXFactory : IComponentFactory
    {
        private DXComponent _instance;
        ...
        {
            get { return "Automates load removal for Deus Ex."; }
        }
        ...
        public IComponent Create(LiveSplitState state)
        {
            ...
            if (_instance != null && !_instance.Disposed)
            {
                ...
                MessageBox.Show(
                    "LiveSplit.DX is already loaded in the " +
            ...
            return (_instance = new DXComponent(state, createAsLayoutComponent));
        }
        ...
        {
            get { return "https://raw.githubusercontent.com/SuiMachine/LiveSplit.DX/master/"; }
        }
        ...
        {
            get { return this.UpdateURL + "Components/update.LiveSplit.DX.xml"; }
        }
    }
